...
//using Microsoft.Health.Dicom.CosmosDb. featuer the schema model //***TODO*** 
//using Microsoft.Health.CosmosDb.Features.Schema.Model; //***TODO***

namespace Microsoft.Health.Dicom.CosmosDb //***TODO*** anything else?
{
    internal class DicomTagCosmosDbEntry
    {
        private static readonly IReadOnlyDictionary<DicomTag, DicomTagCosmosDbEntry> CoreQueryTagToCosmosDbMapping = new Dictionary<DicomTag, DicomTagCosmosDbEntry>()
        {
            { DicomTag.StudyInstanceUID, new DicomTagCosmosDbEntry(SOMETHING, VLatest.Study.StudyInstanceUid) },
            { DicomTag.StudyDate, new DicomTagCosmosDbEntry(SOMETHING, VLatest.Study.StudyDate) },
            { DicomTag.StudyDescription, new DicomTagCosmosDbEntry(SOMETHING, VLatest.Study.StudyDescription) },
            { DicomTag.AccessionNumber, new DicomTagCosmosDbEntry(SOMETHING, VLatest.Study.AccessionNumber) },
